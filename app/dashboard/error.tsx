  ...
  return (
    <div className="max-w-lg mx-auto py-16 px-4 text-center">
      ...
      <p className="text-sm mb-4 leading-relaxed text-[var(--text-secondary)]">
        Lo más habitual es que la base en Railway esté desactualizada respecto al código (falta una migración) o que{" "}
        <code className="rounded bg-[var(--surface-elevated)] px-1.5 py-0.5 font-mono text-[13px] text-[var(--accent)]">DATABASE_URL</code>{" "}
        no apunte al servicio Postgres del mismo proyecto. Revisá el deploy: el paso{" "}
        <code className="font-mono text-[12px] text-[var(--text-tertiary)]">prisma migrate deploy</code> tiene que
