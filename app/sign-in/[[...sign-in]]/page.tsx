  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "#07070a" }}>
      ...
      <div style={{ position: "relative", textAlign: "center" }}>
        <Link href="/" style={{ fontFamily: "var(--font-syne)", fontWeight: 800, fontSize: "1.5rem", letterSpacing: "-0.03em", color: "#eceae5", textDecoration: "none", display: "block", marginBottom: 32 }}>
